...
void vadd(  
    ...
    hls::stream<t_idx_pack>& idx_in, hls::stream<int>& out
    );
}
...
void load_access_idx(
    ...
    // const int access_idx_local[trip_count_item_num], 
    hls::stream<int>& idx_buffer_HBM0, hls::stream<int>& idx_buffer_HBM1, 
    hls::stream<int>& idx_buffer_HBM2, hls::stream<int>& idx_buffer_HBM3, 
    hls::stream<int>& idx_buffer_HBM4, hls::stream<int>& idx_buffer_HBM5, 
    hls::stream<int>& idx_buffer_HBM6, hls::stream<int>& idx_buffer_HBM7, 
    hls::stream<int>& idx_buffer_HBM8, hls::stream<int>& idx_buffer_HBM9, 
    hls::stream<int>& idx_buffer_HBM10, hls::stream<int>& idx_buffer_HBM11, 
    hls::stream<int>& idx_buffer_HBM12, hls::stream<int>& idx_buffer_HBM13, 
    hls::stream<int>& idx_buffer_HBM14, hls::stream<int>& idx_buffer_HBM15, 
    hls::stream<int>& idx_buffer_HBM16, hls::stream<int>& idx_buffer_HBM17, 
    hls::stream<int>& idx_buffer_HBM18, hls::stream<int>& idx_buffer_HBM19, 
    hls::stream<int>& idx_buffer_HBM20, hls::stream<int>& idx_buffer_HBM21, 
    hls::stream<int>& idx_buffer_HBM22, hls::stream<int>& idx_buffer_HBM23, 
    hls::stream<int>& idx_buffer_HBM24, hls::stream<int>& idx_buffer_HBM25, 
    hls::stream<int>& idx_buffer_HBM26, hls::stream<int>& idx_buffer_HBM27, 
    hls::stream<int>& idx_buffer_HBM28, hls::stream<int>& idx_buffer_HBM29, 
    hls::stream<int>& idx_buffer_HBM30, hls::stream<int>& idx_buffer_HBM31, 
    hls::stream<int>& idx_buffer_DDR0, hls::stream<int>& idx_buffer_DDR1,
    hls::stream<int>& idx_buffer_PLRAM0, hls::stream<int>& idx_buffer_PLRAM1, 
    hls::stream<int>& idx_buffer_PLRAM2, hls::stream<int>& idx_buffer_PLRAM3);
